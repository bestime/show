...
// └────────────────────────────────────────────────────────────────────┘ \\
;function ParticleSlider(imgData, a) {
  var b = this;
  ...
  ,
  b.imgControlPrev.src = imgData,
  b.imgControlNext.src = imgData) : b.showArrowControls = !1,
  b.width <= 0 && (b.width = b.$container.offsetWidth),
  b.height <= 0 && (b.height = b.$container.offsetWidth),
  b.mouseDownRegion = 0,
...
ParticleSlider.prototype.getCw = function() {
  var a = this;
  return a.$container.offsetWidth
}
,
ParticleSlider.prototype.getCh = function() {
  var a = this;
  return a.$container.offsetHeight
}
,
